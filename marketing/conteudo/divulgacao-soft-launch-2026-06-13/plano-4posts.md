# Soft launch — 4 posts reais com links rastreados

> Conceito: ela não "lança" nada. Ela usa o sistema no dia a dia e o link aparece
> como consequência natural. Cada post serve dois propósitos: **captar lead pra Ju**
> e **demonstrar o sistema funcionando** (para futuros clientes corretores via Gabriel).

---

## Os 4 posts — situações reais

### Post 1 — Bastidor de atendimento (dia 1)
**Situação:** ela acabou de mostrar um imóvel ou está saindo de uma visita.
**Story:**
...
### Post 2 — Gancho de indicação (dia 2 ou 3)
**Situação:** ela recebeu um lead por indicação (acontece toda semana com ela).
**Story:**
...
isso pra futuros corretores: "olha, 40% dos leads vieram de indicação, e a gente mede isso".

---

### Post 3 — Imóvel em destaque (dia 4 ou 5)
**Situação:** um imóvel novo entrando no estoque, ou um que ela quer girar.
...
### Post 4 — Fechamento e CTA direto (dia 6 ou 7)
**Situação:** fim de semana ou fecha a semana.
**Story:**
...
## Estratégia de indicação (ponto forte da Ju)

Como a base de indicação dela é forte, vale um movimento extra além dos posts:
...
aparece como `indicacao` no painel. Dados reais de quanto a rede dela vale.

---

## Como Gabriel usa isso depois (produto)

Os 4 posts geram dados reais em 1 semana:
- Qual origem converte mais (`story` vs `indicacao` vs `lancamento`)
- Quantas visitas vs leads (taxa de conversão real)
- Qual tipo de imóvel atrai mais interesse (pelo texto do story)

Ao apresentar o sistema pra um novo corretor:
> "Em 4 posts orgânicos, a Juliana gerou X leads. 40% vieram de indicação — e a gente mede isso."
**Isso é a vitrine. Não precisa falar do sistema — os números falam.**

---

## Links prontos pra semana
